...
<div class="gf-modal is-open">
    ...
    <div class="gf-modal__content gf_contribution_success_modal_container">
        ...
        <h1 class="gf_title"><?php echo esc_html(!empty($contribution->confirmation_title) ? $contribution->confirmation_title : __('Pledge Successful', 'growfund')); ?></h1>
        <p class="gf_subtitle"><?php echo esc_html(!empty($contribution->confirmation_description) ? $contribution->confirmation_description : __('Thank you for backing this campaign. Your support brings the campaign closer to life.', 'growfund')); ?></p>

        <div class="gf_divider"></div>

        <div class="gf_total_contribution">
            <div class="gf_total_label"><?php echo esc_html__('Total Pledged Campaign', 'growfund'); ?></div>
        ...
        <div class="gf_details_grid">
            ...
            <div class="gf_detail_item">
                <div class="gf_detail_label"><?php echo esc_html__('Reward Tier', 'growfund'); ?></div>
                <div class="gf_detail_value"><?php echo esc_html(!empty($contribution->reward_title) ? $contribution->reward_title : 'N/A'); ?></div>
            </div>
            <div class="gf_detail_item">
        ...
        <div class="gf_details_grid">
            <div class="gf_detail_item">
                <div class="gf_detail_label"><?php echo esc_html__('Backer Name', 'growfund'); ?></div>
        ...
        <?php if (gf_payment_engine() === PaymentEngine::NATIVE && $contribution->is_future_payment) : ?>
            <div class="gf_contribution_info">
